<%@ Page Title="الرد على الملاحظات " Language="C#" MasterPageFile="~/MasterPage.master" CodeFile="~/ManagerReports.aspx.cs" AutoEventWireup="true" Inherits="ManagerReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h3><img src="assets/icons/BasicIcon/Tri2.png" style="height: 49px; margin-left: 11px; margin-right: 2px; margin-top: -5px; "/>ملاحظات وتوصيات :   <span runat="server" id="Adm"></span></h3>
                    ...
                    <div class="col-xs-12 col-sm-3">
                        ...
                        <label class=" control-label blue" for="form-field-1">بحث بحالة التكرار  </label>
                        <div class="form-group">
                            <label>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-5">
                    ...
                    <div class="form-group">
                        <label class=" control-label blue" for="form-field-1">بحث بمستوى الأهمية  </label>
                    ...
                    <div class="form-group">
                        <label class=" control-label blue" for="form-field-1">بحث بحالة التنفيذ للملاحظة  </label>
                            ...
                            <asp:RadioButtonList ID="RadioStatus" AutoPostBack="true" runat="server" OnSelectedIndexChanged="RadioStatus_SelectedIndexChanged" RepeatDirection="Horizontal" CssClass="radioboxlist" CellPadding="20" CellSpacing="20" Font-Bold="True" ForeColor="White">
                                   <asp:ListItem  Value='3'><img width="90"  src="assets/images/Icons/levels/L2/solved.png"  /></asp:ListItem>
                                    <asp:ListItem  Value='2'><img width="110" src="assets/images/Icons/levels/L2/under.png" /></asp:ListItem>
                                    <asp:ListItem Selected="True"  Value='1'><img width="90"  src="assets/images/Icons/levels/L2/hold.png" /></asp:ListItem>
                                    <asp:ListItem  Value="5"><img width="90" src="assets/images/Icons/levels/L2/closed.png" /></asp:ListItem>
                                    <asp:ListItem  Value="4"><img width="145" src="assets/images/Icons/levels/L2/notstart.png" /></asp:ListItem>
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                        <ContentTemplate>
                            <div class="clearfix">
                                <div class="pull-right tableTools-container pull-left DReport"></div>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                                ...
                                <table id="dynamic-Notes" class=" table-striped table-bordered">
                                     ...
                                     <thead class="TableHead">
                                        ...
                                        <hr />
                                            ...
                                            <th style="display:none;">أهمية التوصية 
                                            </th>
                                        ...
                                        <asp:Repeater ID="RepNotes" OnItemDataBound="RepNotes_ItemDataBound" runat="server">
                                            <ItemTemplate>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="LblRepp" class="center" runat="server" Text='<%# Eval("NoteID") %>'></asp:Label>
                                                        <hr class="center" style="margin-top: 1px; margin-bottom: 1px; border-top: 1px solid #6ad589;" />
                        ...
                        <div class="col-xs-12 col-sm-12">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="wysiwyg-editor" style="max-height: 90px; " runat="server" id="editor1"></div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
