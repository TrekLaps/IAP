...
public partial class ReportingAdm : System.Web.UI.Page
{
    ...
    protected void RepReports_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        {
            if (MyRecDataSet.Tables[0].Rows[0]["AdmID"] != "0")
            {
                if (RadioStatus.SelectedIndex != -1)
                {
    ...
    protected void RepAdmins_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
	  ...
	  when " + Imp + @" = 0 then dbo.Reports.Importance
        ...
        else
        {
            ...
            var sqlwhere0 = @" dbo.Reports.RepAdms= " + Convert.ToInt32(((Label)e.Item.FindControl("DepartID")).Text) + @" AND (dbo.Reports.RepSection = " + Convert.ToInt32(((Label)e.Item.FindControl("SectID")).Text) + ") ";
