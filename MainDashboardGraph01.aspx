<%@ Page Title=" نتائج معالجة الملاحظات " MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MainDashboardGraph01.aspx.cs" Inherits="MainDashboardGraph01" %>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-5" style="z-index: 999; font-size: 20px; margin-top: 55px;">
                                                    ...
                                                    <div class="row" style="padding-top:60px; text-align:right;">
                                                        ...
                                                        <asp:HyperLink ID="HyperLink1" NavigateUrl="ReportingAll.aspx" runat="server">
                                        ...
                                        <div align='center' style="text-align: center;">
                                            ...
                                            <div style="display: inline-block; text-align: center;">
                                                <div align='center' style="color: #070707; background-color: #FFFFFF; border: 1px solid #D8D8D8; margin: 25px;  height: 935px; width: 1000px; text-align: center;">
                                                   ...
                                                   <!-- <p>
                                                        <a href="SectionsCharts.aspx" class="Bttn" style="background-color: #e6e6e6; font-weight: bold;">
                                                            <img src="assets/icons/buttons/risk.png" width="160" height="60" alt="" /></a>
                                                    </p> -->
                                                                    ...
                                                                    <asp:Repeater ID="Repeater2Years" runat="server">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <td class="center thover" style="white-space: nowrap; margin: 0; padding: 0; width: 20px;">
                                                                                ...
                                                                                <div class="tdcolor">
                                                                                    <asp:HyperLink ID="LinkButton1" Text='<%# Eval("Status1") %>' NavigateUrl='<%#"ReportingAdmSections.aspx?E=1&ReqYR=0&Reqq="+ Eval("RepSection").ToString() %>' runat="server"></asp:HyperLink>
                                                                                </div>
                                                                                <div class="tdcolor">
                                                                                    <asp:HyperLink ID="HyperLink1" Text='<%# Eval("Status2") %>' NavigateUrl='<%#"ReportingAdmSections.aspx?E=2&ReqYR=0&Reqq="+ Eval("RepSection").ToString() %>' runat="server"></asp:HyperLink>
                                                                                </div>
                                                                                <div class="tdcolor">
                                                                                    <asp:HyperLink ID="HyperLink2" Text='<%# Eval("Status4") %>' NavigateUrl='<%#"ReportingAdmSections.aspx?E=4&ReqYR=0&Reqq="+ Eval("RepSection").ToString() %>' runat="server"></asp:HyperLink>
                                                                                </div>
                                                                                <div class="tdcolor ">
                                                                                    <asp:HyperLink ID="HyperLink3" Text='<%# Eval("Status3") %>' NavigateUrl='<%#"ReportingAdmSections.aspx?E=3&ReqYR=0&Reqq="+ Eval("RepSection").ToString() %>' runat="server"></asp:HyperLink>
                                                                                </div>

                                                                                <div class="tdcolor">
                                                                                    <asp:HyperLink ID="HyperLink4" Text='<%# Eval("Status5") %>' NavigateUrl='<%#"ReportingAdmSections.aspx?E=5&ReqYR=0&Reqq="+ Eval("RepSection").ToString() %>' runat="server"></asp:HyperLink>
                                                                                </div>
                                        ...
                                        <div align='center' style="text-align: center;">
                                            ...
                                            <div style="display: inline-block; text-align: center;">
                                                <div align='center' style="color: #070707; background-color: #FFFFFF; border: 1px solid #D8D8D8; margin: 25px;  height: 935px; width: 1000px; text-align: center;">
                                                                            ...
                                                                            <asp:Repeater ID="RepImpDataAdm" OnItemDataBound="RepImpDataAdm_ItemDataBound" OnDisposed="RepImpDataAdm_Disposed" runat="server">
                                                                                <ItemTemplate>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="center" style="padding: 10px">
                                                                                            <div id="LowValAdm" visible="false" runat="server">
                                                                                                <img src="assets/icons/levels/L1/mid2.png" height="25" /></div>
                                                                                            <div id="MidValAdm" visible="false" runat="server">
                                                                                                <img src="assets/icons/levels/L1/low2.png" height="25" /></div>

                                                                                            <div id="HighValAdm" visible="false" runat="server">
                                                                                                <img src="assets/icons/levels/L1/high2.png" height="25" /></div>
                                                  ...
                                                  <!--  <p>
                                                        <a href="AdminsCharts.aspx" class="Bttn" style="background-color: #e6e6e6; font-weight: bold;">
                                                            <img src="assets/icons/buttons/risk.png" width="160" height="60" alt="" /></a>
                                                    </p> -->
                                                                    ...
                                                                    <asp:Repeater ID="Repeater2" runat="server">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <td class="center thover" style="white-space: nowrap; margin: 0; padding: 0; width: 20px;">
                                                                                ...
                                                                                <div class="tdcolor">
                                                                                    <asp:HyperLink ID="LinkButton1" Text='<%# Eval("Status1") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?S="+Eval("Section")+"&G=1&E=1&YQ=0&Reqq="+ Eval("RepAdms").ToString() %>' runat="server"></asp:HyperLink>
                                                                                </div>
                                                                                <div class="tdcolor">
                                                                                    <asp:HyperLink ID="HyperLink1" Text='<%# Eval("Status2") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?S="+Eval("Section")+"&G=1&E=2&YQ=0&Reqq="+ Eval("RepAdms").ToString() %>' runat="server"></asp:HyperLink>
                                                                                </div>
                                                                                <div class="tdcolor">
                                                                                    <asp:HyperLink ID="HyperLink2" Text='<%# Eval("Status4") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?S="+Eval("Section")+"&G=1&E=4&YQ=0&Reqq="+ Eval("RepAdms").ToString() %>' runat="server"></asp:HyperLink>
                                                                                </div>
                                                                                <div class="tdcolor ">
                                                                                    <asp:HyperLink ID="HyperLink3" Text='<%# Eval("Status3") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?S="+Eval("Section")+"&G=1&E=3&YQ=0&Reqq="+ Eval("RepAdms").ToString() %>' runat="server"></asp:HyperLink>
                                                                                </div>

                                                                                <div class="tdcolor">
                                                                                    <asp:HyperLink ID="HyperLink4" Text='<%# Eval("Status5") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?S="+Eval("Section")+"&G=1&E=5&YQ=0&Reqq="+ Eval("RepAdms").ToString() %>' runat="server"></asp:HyperLink>
                                                                                </div>
