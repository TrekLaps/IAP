<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReportAdmAll.aspx.cs" Inherits="ReportAdmAll" %>
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select onchange="SelectYear()" style="font-size: 18px;" multiple="true" id="YearList" runat="server" name="state" class="select2" data-placeholder="جميع السنوات">
                                            </select>
                        ...
                        <div id="dvContents">
                            ...
                            <asp:Repeater ID="RepYears" runat="server" OnItemDataBound="RepYears_ItemDataBound">
                                <ItemTemplate>
                                    ...
                                    <div class="row">
                                        <div align="center" id="yr" class='<%# Container.ItemIndex == 0 ? "ReportY0 col-lg-12" : "ReportY col-lg-12" %>' runat="server" style="background-color: #92cb81; color: white; width: 100%; border-bottom: 1px black;">
                                    ...
                                    <asp:Repeater ID="RepReports" runat="server" OnItemDataBound="RepReports_ItemDataBound">
                                        <ItemTemplate>
                                            <div class="row">
                                                <div align="center" class="ReportMain col-lg-12" style="background-color: rgb(175,171,171); color: black; width: 100%;">
                                            ...
                                            <asp:Repeater ID="RepAdmins" runat="server" OnItemDataBound="RepAdmins_ItemDataBound">
                                                <ItemTemplate>
                                                    <div class="row">
                                                        <div align="center" class="ReportMain col-lg-12" style="background-color: rgb(231,230,230); color: black; width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 5%; text-align: center">
                                                                                ...
                                                                                <span id="Closed" visible="false" runat="server">
                                                                                 ...
                                                                                 <hr class="margin-3" style="border-top: 1px solid #73bb55;" />
                                        ...
                                        <div class="modal-body">
                                            <div style="margin-top: 7px;" class="row">
                                                ...
                                                <div class="col-lg-8" style="text-align: right;">
                                                    <h4 class="align-right">سوف يتم ارسال اشعار بالملاحظة وجميع التوصيات الى الموظفين </h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 no-padding no-margin" style="margin-bottom: 10px;">
                                                    ...
                                                    <label class="control-label" for="form-field-1">الموظفين  </label>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Javascript" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function PrintDiv() {
            ...
            frameDoc.document.write('</head><body style="width:100%" class="no-skin rtl"><style>.RepPrn{border-bottom: 1px solid black;}.RepContent{border-bottom: 1px solid black;}@page { margin: 2cm;size: landscape;}</style>');
