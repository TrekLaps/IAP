<%@ Page Title="الاطلاع على الملاحظات  " Language="C#" MasterPageFile="~/MasterPage.master" CodeFile="~/ReportsView.aspx.cs" AutoEventWireup="true" Inherits="ReportsView" %>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 no-padding no-margin" style="margin-bottom: 15px;">
            ...
            <div runat="server" id="MainSave">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-md-4">
                        ...
                        <div class="col-md-8">
                            <input type="date" id="DFromNoteUDP" autocomplete="off" class="form-control form-control-1 input-sm from" runat="server" placeholder="يوم - شهر -سنة" />
...
<img src="assets/icons/BasicIcon/resp.png" height="45" />
                                            ...
                                            <asp:Label ID="ComCount" runat="server" Text='<%# Eval("ComCount") %>'></asp:Label></span>
        ...
        <div style="padding: 15px; border: 1px solid #E0E2E5; background-color: #FFF;">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-md-12">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" ForeColor="Red" Display="Dynamic" ValidationGroup="GFileRepl" runat="server" ControlToValidate="FileUploadR" ErrorMessage="*مطلوب رفع ملف"></asp:RequiredFieldValidator>
                    ...
                    <div class="col-md-5">
                        ...
                        <asp:Button ID="AddFile" CssClass="btn btn-success" OnClick="AddFile_Click" ValidationGroup="GFile7" runat="server" />
            ...
            <div class="row" style="padding-top: 10px;">
                ...
                <asp:Button ID="SaveComment"  CssClass="btn btn-success" OnClick="SaveComment_Click" runat="server" />
    ...
    <div id="AllFiles_modal" runat="server" style="display: none;">
        ...
        <div style="padding: 15px; border: 1px solid #E0E2E5; background-color: #FFF;">
            ...
            <div class="row" style="margin-top: 10px;">
             ...
             <div>
            <asp:LinkButton ID="BackRepliesFiles" runat="server" OnClick="BackReplies_Click" Style="float: left; margin-top: -10px;"><i class="ace-icon fa fa-arrow-left icon-only purple bigger-250"></i></asp:LinkButton>
        </div>
        </div>
    </div>
    <!--------------------------------->
