<%@ Page Title="نتائج معالجة ملاحظات الإدارة العليا " MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PieDashboard02.aspx.cs" Inherits="PieDashboard02" %>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                    <h2 style="margin-top: 2px;">
                                        <span runat="server" id="Span1">نتائج معالجة الملاحظات على مستوى الإدارات عليا </span>
                                    </h2>
                                </div>
                                <div class="col-md-6">
                            </div>
                                                    ...
                                                    <div class="row" style="background: none; margin-bottom: 2px;">
                                                        ...
                                                        <div class="col-xs-10 GreenImp-tooltip" style="text-align: right;">منخفضة</div>
                                                                                                        ...
                                                                                                        <div class="row" style="padding-top:60px; text-align:right;">
                                                                                                            <asp:HyperLink ID="ReportingLnk" runat="server">
                                            ...
                                            <div class="col-md-12">
                                                <div style="text-align: right;">
                                                    <h2 style="margin-top: 2px;">
                                                        ...
                                                        <span runat="server" id="Span4">نتائج معالجة الملاحظات على مستوىالإدارات المتوسطة </span>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div style="text-align: right;">
                                                                            <h2 style="margin-top: 2px;">
                                                                                ...
                                                                                <span runat="server" id="Span3">نتائج معالجة الملاحظات على مستوىالإدارات المتوسطة </span>
                                                                                        ...
                                                                                        <asp:Repeater ID="Repeater2" runat="server">
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                ...
                                                                                                <td class="center thover" style="white-space: nowrap; margin: 0; padding: 0; width: 20px;">
                                                                                                    ...
                                                                                                    <div class="tdcolor">
                                                                                    <asp:HyperLink ID="LinkButton1" Text='<%# Eval("Status1") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?E=1&YQ="+Request.QueryString["ReqYR"]+"&S="+ Request.QueryString["Reqq"]+"&Reqq="+ Eval("RepAdms").ToString() %>' runat="server"></asp:HyperLink>                                                                                   </div>
                                                                                <div class="tdcolor">
                                                                                <asp:HyperLink ID="HyperLink1" Text='<%# Eval("Status2") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?E=2&YQ="+Request.QueryString["ReqYR"]+"&S="+ Request.QueryString["Reqq"]+"&Reqq="+ Eval("RepAdms").ToString() %>' runat="server"></asp:HyperLink> </div>
                                                                                <div class="tdcolor">
                                                                                <asp:HyperLink ID="HyperLink2" Text='<%# Eval("Status4") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?E=4&YQ="+Request.QueryString["ReqYR"]+"&S="+ Request.QueryString["Reqq"]+"&Reqq="+ Eval("RepAdms").ToString() %>' runat="server"></asp:HyperLink>  </div>
                                                                                <div class="tdcolor ">
                                                                               <asp:HyperLink ID="HyperLink3" Text='<%# Eval("Status3") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?E=3&YQ="+Request.QueryString["ReqYR"]+"&S="+ Request.QueryString["Reqq"]+"&Reqq="+ Eval("RepAdms").ToString() %>' runat="server"></asp:HyperLink>   </div>

                                                                                <div class="tdcolor">
                                                                              <asp:HyperLink ID="HyperLink4" Text='<%# Eval("Status5") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?E=5&YQ="+Request.QueryString["ReqYR"]+"&S="+ Request.QueryString["Reqq"]+"&Reqq="+ Eval("RepAdms").ToString() %>' runat="server"></asp:HyperLink>  </div>
