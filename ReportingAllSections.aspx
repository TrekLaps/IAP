<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReportingAllSections.aspx.cs" Inherits="ReportingAllSections" %>
                                        ...
                                        <div class="modal-body">
                                            <div style="margin-top: 7px;" class="row">
                                                ...
                                                <div class="col-lg-8" style="text-align: right;">
                                                    <h4 class="align-right">سوف يتم ارسال اشعار بالملاحظة وجميع التوصيات الى المديريرن </h4>
