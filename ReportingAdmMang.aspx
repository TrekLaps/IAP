<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReportingAdmMang.aspx.cs" Inherits="ReportingAdmMang" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <div style="display: none;" class="widget-toolbar hidden-print">
