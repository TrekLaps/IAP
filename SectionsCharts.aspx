<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SectionsCharts.aspx.cs" Inherits="SectionsCharts" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h3>
        ...
        <span runat="server" id="PagTitle">مستوى الأهمية على مستوى الإدارات عليا</span>
    </h3>
    <div class="MainBox">
    ...
    <div align='center'>
        ...
        <asp:DataList ID="AdminsListAll" runat="server" RepeatDirection="Horizontal" BackColor="#F8F8F8" CssClass="center" CellPadding="0" CellSpacing="0" ItemStyle-CssClass="center padding-0" RepeatColumns="2" OnItemDataBound="AdminsListAll_ItemDataBound">
            ...
            <ItemTemplate>
                ...
                <div style="color: #070707; direction: ltr; display: inline-block; text-align: center; background-color: #FFFFFF; border: 1px solid #D8D8D8; margin: 25px; padding-right: 25px;  height: 350px; width: 475px; text-align: center;">
                    ...
                    <asp:Label ID="RepSection" Visible="false" runat="server" Text='<%# Eval("RepSection") %>'></asp:Label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5" style="z-index: 999; font-size: 20px; margin-top: 55px;">
                                                    <div class="row" style="background: none;">
                                                        ...
                                                        <div class="col-xs-10" style="text-align: right;">مرتفعة</div>
                                                    </div>
                                                    <div class="row" style="background: none; margin-bottom: 2px;">
                                                        <div class="col-xs-2">
                                                            <img src="assets/icons/levels/L1/low2.png" height="25" />
                                                        </div>
                                                        <div class="col-xs-10" style="text-align: right;">متوسطة</div>
                                                    </div>
                                                    ...
                                                    <div class="row" style="background: none; margin-bottom: 2px;">
                                                        ...
                                                        <div class="col-xs-10" style="text-align: right;">منخفضة</div>
                                                    </div>
                        ...
                        <div class="col-xs-7">
                            <div style="text-align: center;" align='center'>
                                ...
                                <div id='Section<%# Eval("RepSection") %>'></div>
                            </div>
