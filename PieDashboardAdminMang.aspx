<%@ Page Title="نتائج معالجة ملاحظات الإدارة متوسطة " MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PieDashboardAdminMang.aspx.cs" Inherits="PieDashboardAdminMang" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                ...
                <ContentTemplate>
                    <%--<h3>
                         نتائج معالجة الملاحظات على مستوىالإدارات المتوسطة
                           </h3>--%>
                    <div class="MainBox">
                         ...
                         <div class="row">
                            <div class="col-md-6">
                                    <h2 style="margin-top: 2px;">
                                        <span runat="server" id="Span1">نتائج معالجة الملاحظات على مستوىالإدارات المتوسطة </span>
                                    </h2>
                                </div>
                                <div class="col-md-6">
                            </div>
                        ...
                        <div class="alert alert-info" runat="server" id="NoRep" style="display:none;">
                                            ...
                                            <div style="direction: ltr;">
                                                <div align='center' style="text-align: center;">
                                                    ...
                                                    <div style="display: inline-block; text-align: center;">
                                                        ...
                                                        <br />
                                                        <div align='center' style="color: #070707;display: inline-block;text-align: center;background-color: #FFFFFF;/* border: 1px solid #D8D8D8; */margin: 25px;/*  */padding-right: 20px;height: 370px;width: 475px;text-align: center;">
                                                            <h4>مستوى التنفيذ </h4>
                                                            <div class="row">
                                                                <div class="col-xs-6" style="z-index: 999; font-size: 20px; margin-top:55px; color: #000;">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12" align="center" style="direction: rtl; margin-top: 35px;">
                                                                        <table id="dynamic-table" class="color">
                                                                            <tr>
                                                                                <th class="thcolor" style="200px;">&nbsp;</th>
                                                                        ...
                                                                        <div class="row tdcolor" style="margin: 0; text-align:right;background-color:#e6e6e6;">
                                                                               إجمالى الملاحظات
                                                                                ...
                                                                                <asp:Repeater ID="RepTotals" runat="server">
                                                                                    <ItemTemplate>
                                                                                        <td style="white-space: nowrap; margin: 0;vertical-align:middle; direction: rtl; padding: 0; width: 80%;text-align:center;" class="thover">
                                                                                           <div class="row tdcolor" style="margin: 0; margin-right:10px;">
                                                                                    <asp:HyperLink ID="LinkButton1" Text='<%# Eval("TotalNotDone") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?Adm=1&E=1&YQ="+Request.QueryString["ReqY"]+"&S="+ Request.QueryString["S"]+"&Reqq="+ Request.QueryString["Reqq"].ToString() %>' runat="server"></asp:HyperLink>                                                                                   </div>
                                                                                 <div class="row tdcolor" style="margin: 0 ; margin-right:10px;">
                                                                                <asp:HyperLink ID="HyperLink1" Text='<%# Eval("TotalSemiDone") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?Adm=1&E=2&YQ="+Request.QueryString["ReqY"]+"&S="+ Request.QueryString["S"]+"&Reqq="+ Request.QueryString["Reqq"].ToString() %>' runat="server"></asp:HyperLink> </div>
                                                                                 <div class="row tdcolor" style="margin: 0 ; margin-right:10px;">
                                                                                <asp:HyperLink ID="HyperLink2" Text='<%# Eval("TotalNotNow") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?Adm=1&E=4&YQ="+Request.QueryString["ReqY"]+"&S="+ Request.QueryString["S"]+"&Reqq="+ Request.QueryString["Reqq"].ToString() %>' runat="server"></asp:HyperLink>  </div>
                                                                                 <div class="row tdcolor" style="margin: 0 ; margin-right:10px;">
                                                                               <asp:HyperLink ID="HyperLink3" Text='<%# Eval("TotalDone") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?Adm=1&E=3&YQ="+Request.QueryString["ReqY"]+"&S="+ Request.QueryString["S"]+"&Reqq="+ Request.QueryString["Reqq"].ToString() %>' runat="server"></asp:HyperLink>   </div>

                                                                                 <div class="row tdcolor" style="margin: 0 ; margin-right:10px;">
                                                                              <asp:HyperLink ID="HyperLink4" Text='<%# Eval("TotalClosed") %>' NavigateUrl='<%#"ReportAdmAllMang.aspx?Adm=1&E=5&YQ="+Request.QueryString["ReqY"]+"&S="+ Request.QueryString["S"]+"&Reqq="+ Request.QueryString["Reqq"].ToString() %>' runat="server"></asp:HyperLink>  </div>
