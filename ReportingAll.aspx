<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReportingAll.aspx.cs" Inherits="ReportingAll" %>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            <select onchange="SelectYear()" style="font-size: 18px; text-align: right;" multiple="true" id="YearList" runat="server" name="state" class="select2" data-placeholder="اختر الخطة">
                                            </select>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            ...
                                            <asp:DropDownList class="chosen-select chosen-rtl form-control" ID="SectorList" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="SectorList_SelectedIndexChanged" runat="server" data-placeholder=" حالة الملاحظة">
                                                <asp:ListItem Value='0'>اختر الإدارة العليا</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            ...
                                            <asp:DropDownList class="chosen-select chosen-rtl form-control" ID="AdminList" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="AdminList_SelectedIndexChanged" runat="server" data-placeholder=" حالة الملاحظة">
                                                <asp:ListItem Value='0'>اختر الإدارة متوسطة</asp:ListItem>
                                            </asp:DropDownList>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Javascript" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function DisplayCurrentTime() {
            ...
            $('#MsgReport_modal').on('show.bs.modal', function (e) {
