...
public partial class ReportAdmAll : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["UData"] != null)
            {
                ...
                {
                   YearList.DataSource = Obj.GetDataSetByID("GetPlansByAdmin", Convert.ToInt32(MyRecDataSet.Tables[0].Rows[0]["AdmID"]));
                    ...
                    if (Request.QueryString["YQ"] != null)
                    {
                        ...
                        if (YearList.SelectedIndex == -1)
                        {
                            ...
                            if (RadioStatus.SelectedIndex != -1)
                            {
                                ...
                                sqlwhere0 += " ) AND RepSection= " + MyRecDataSet.Tables[0].Rows[0]["Section"] + "AND RepAdms=" + MyRecDataSet.Tables[0].Rows[0]["AdmID"];
	  ...
	  when " + DropImport.SelectedValue + @" = 0 then dbo.Reports.Importance
						...
						";
                                ...
                                sqlstr += sqlwhere0;
                                if (Convert.ToInt32(MyRecDataSet.Tables[0].Rows[0]["AdmID"]) != 0)
                                {
                                    sqlstr += "AND RepSection= " + MyRecDataSet.Tables[0].Rows[0]["Section"] + " AND RepAdms=" + Convert.ToInt32(MyRecDataSet.Tables[0].Rows[0]["AdmID"]);
                                }
                                else if (Convert.ToInt32(MyRecDataSet.Tables[0].Rows[0]["AdmID"]) == 0 )
                                {
                                    sqlstr += "AND RepSection= " + MyRecDataSet.Tables[0].Rows[0]["Section"];
                                }
	  ...
	  when " + DropImport.SelectedValue + @" = 0 then dbo.Reports.Importance
						...
						";
                                ...
                                sqlwhere += "AND RepSection= " + MyRecDataSet.Tables[0].Rows[0]["Section"] + "AND RepAdms=" + MyRecDataSet.Tables[0].Rows[0]["AdmID"];
	  ...
	  when " + DropImport.SelectedValue + @" = 0 then dbo.Reports.Importance
						...
						";
                                ...
                                sqlstr += " ) AND RepSection= " + MyRecDataSet.Tables[0].Rows[0]["Section"] + "AND RepAdms=" + MyRecDataSet.Tables[0].Rows[0]["AdmID"];
    ...
    protected void BackCharts_Click(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["YQ"] != null && Request.QueryString["YQ"] != "0")
        {
            Response.Redirect("PieDashboardAdmin.aspx?S=" + MyRecDataSet.Tables[0].Rows[0]["Section"] + "&ReqY=" + Request.QueryString["YQ"] + "&Reqq=" + Convert.ToString(MyRecDataSet.Tables[0].Rows[0]["AdmID"]));
        }
        else
        {
            Response.Redirect("PieDashboardAdmin.aspx?S=" + MyRecDataSet.Tables[0].Rows[0]["Section"] + "&ReqY=0&Reqq=" + Convert.ToString(MyRecDataSet.Tables[0].Rows[0]["AdmID"]));
    ...
    protected void RepReports_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        if (RadioStatus.SelectedIndex != -1)
        {
            ...
            var sqlwhere0 = "AND RepAdms=" + MyRecDataSet.Tables[0].Rows[0]["AdmID"] + " AND" + @"(dbo.Reports.RepSection = " + Convert.ToInt32(((Label)e.Item.FindControl("SectionID")).Text) + ") AND (dbo.Reports.RepStatus=0";
	  ...
	  when " + DropImport.SelectedValue + @" = 0 then dbo.Reports.Importance
        ...
        {
            ((Repeater)e.Item.FindControl("RepAdmins")).DataSource = Obj.GetDataSetBy3ID("ReportAdminsPlanAllAdm", Convert.ToInt32(((Label)e.Item.FindControl("SectionID")).Text), Convert.ToInt32(((Label)e.Item.FindControl("PlanID")).Text), Convert.ToInt32(MyRecDataSet.Tables[0].Rows[0]["AdmID"]));
    ...
    protected void RepYears_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (((Label)e.Item.FindControl("YearID")).Text != "")
        {
            ...
            DataSet MyRecDataSet = (DataSet)Session["UData"];
            ((Repeater)e.Item.FindControl("RepReports")).DataSource = Obj.GetDataSetBy2ID("RepSectAllByStatIDYear", Convert.ToInt32(((Label)e.Item.FindControl("YearID")).Text), Convert.ToInt32(MyRecDataSet.Tables[0].Rows[0]["Section"]));
    ...
    protected void MsgButton_Command(object sender, CommandEventArgs e)
    {
        ...
        DepartMangList.DataSource = Obj.GetDataSetBy2ID("GetEmpByAdmApprove", Convert.ToInt32(arg[1]), Convert.ToInt32(arg[0]));
