...
public partial class ReportingAll : System.Web.UI.Page
{
    ...
    protected void SectorList_SelectedIndexChanged(object sender, EventArgs e)
    {
	  ...
	  when " + SectorList.SelectedValue + @" = 0 then dbo.Reports.RepSection
end) and (dbo.Reports.RepStatus= dbo.Reports.RepStatus) and dbo.Reports.Importance = (case when " + DropImport.SelectedValue + @" <> 0 then " + DropImport.SelectedValue + @"
	  when " + DropImport.SelectedValue + @" = 0 then dbo.Reports.Importance
end) and   dbo.Reports.Active=1 and dbo.Plans.Active=1 
						";
...
) and dbo.Reports.Importance = (case when " + DropImport.SelectedValue + @" <> 0 then " + DropImport.SelectedValue + @"
	  when " + DropImport.SelectedValue + @" = 0 then dbo.Reports.Importance
end) and   dbo.Reports.Active=1 and dbo.Plans.Active=1 
						";
